...
class Form constructor(validationContainer: ValidationContainer) {
    ...
    fun submitWith(
        ...
        submitWith(SubmitViewWrapper(view), onSubmit)
    }
    ...
    fun submitWith(
        ...
        val submitMenuItemWrapper = SubmitMenuItemWrapper(item)
        submitWith(submitMenuItemWrapper, onSubmit)
    }
    ...
    fun submitWith(
        ...
        this.submitWith = submitWrapper.apply {
            setOnSubmit {
                val result = validate()
                if (result.success()) {
                    onSubmit(result)
    ...
    fun autoSubmitWith(onSubmit: (FormResult) -> Unit) {
        require(useRealTimeValidation)

        submitWith(AutoSubmitWrapper(),onSubmit)
    }
